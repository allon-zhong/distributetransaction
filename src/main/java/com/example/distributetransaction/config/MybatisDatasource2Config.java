...
@MapperScan(basePackages = "com.example.distributetransaction.dao2",  sqlSessionFactoryRef = "sqlSessionFactory2")
public class MybatisDatasource2Config {
    ...
    public SqlSessionFactory sqlSessionFactory2() throws Exception {
        ...
        factoryBean.setMapperLocations(resolver.getResources("classpath:dao2/*.xml"));
