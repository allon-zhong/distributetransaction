...
@MapperScan(basePackages = "com.example.distributetransaction.dao1",  sqlSessionFactoryRef = "sqlSessionFactory")
public class MybatisDatasourceConfig {
    ...
    public SqlSessionFactory sqlSessionFactory() throws Exception {
        ...
        factoryBean.setMapperLocations(resolver.getResources("classpath:dao1/*.xml"));
